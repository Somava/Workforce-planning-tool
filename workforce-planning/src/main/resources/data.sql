...
--------------------------------------------------
INSERT INTO external_employees (id, external_employee_id, provider, contract_id,first_name, last_name, staffing_request_id, project_id, skills, location) VALUES 
(1, 'EXT-001', 'FreelanceHub', 'CONTRACT-001', 'John', 'Doe', 1, 1, '["Java", "Microservices"]', 'Frankfurt') ON CONFLICT (id) DO NOTHING;
